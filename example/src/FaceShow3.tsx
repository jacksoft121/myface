    ...
    (frame) => {
      ...
      runAtTargetFps(15, () => {
        try {
          ...
          const buffer = resized.toArrayBuffer();
          const unboxedInspireFace = BoxedInspireFace.unbox();

          // 使用转换后的 buffer 和尺寸创建 bitmap
          const bitmap = unboxedInspireFace.createImageBitmapFromBuffer(buffer, resized.width, resized.height, 3);
